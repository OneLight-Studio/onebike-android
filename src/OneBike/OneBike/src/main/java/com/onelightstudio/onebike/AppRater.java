...
public class AppRater {
    ...
    public static void appLaunched(Context context) {
        ...
        // Wait for at least the number of launches or the number of days used until prompt
        if ((launch_count >= Constants.RATING_LAUNCHES_UNTIL_PROMPT) || (System.currentTimeMillis() >= date_firstLaunch + (Constants.RATING_DAYS_UNTIL_PROMPT * 24 * 60 * 60 * 1000))) {
